...
atm::extract_cps_nasc(
  ...
  path.out    = "C:\\SURVEY\\2606RL\\PROCESSED\\EV\\CSV", # Processed file destination
  suffix.out  = "_nasc_cps.csv",             # Suffix applied to processed CSV files
  path.img    = "C:\\SURVEY\\2606RL\\PROCESSED\\EV\\Exported_Images", # Location of exported image files, or NULL
  pattern.img = "-38 kHz Sv.png", # Exported image regex
  # Lesser used options --------------------------------------------------------
  ...
  root        = 2,     # Constant for controlling bubble size (2)2
