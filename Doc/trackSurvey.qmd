...
legPalette <- c("#FF0000", "#FFA500", "#008000", "#0000FF", "#8A2BE2", "#FFFF00")
...
According to our calculations, a total of **`r sum(das.summary$das.actual)`** DAS were accomplished of the `r sum(das.summary$das.planned)` DAS planned, resulting in a loss of **`r sum(das.summary$delta.das)` DAS**.
...
According to our calculations, a total of **`r sum(das.summary$das.survey)`** DAS were accomplished of the `r sum(das.summary$das.planned)` DAS planned, resulting in a loss of **`r sum(das.summary$delta.survey)` DAS**.
