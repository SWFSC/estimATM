...
From 7 to 25 August, _Lisa Marie_ sampled nearshore transects 66 to 151, between Monterey, CA and the WA/OR border, returning to port in Westport, WA on 26 August. Then, from 31 August to 6 September, _Lisa Marie_ conducted comparative purse seine sets in close proximity, in both space and time, to _`r survey.vessel`_ nighttime trawls. Finally, from 7 to 11 September, _Lisa Marie_ sampled nearshore transects 152 to 171, between the WA/OR border and Cape Flattery, WA, to conclude the nearshore survey.  
