...
pacman::p_load(tidyverse,swfscMisc,lubridate,sp,mapview,RODBC,leafem,xts,
...
set.specimen.summ <- set.specimens.or %>% 
  ...
  select(key.set, commonName, scientificName, weightg) %>% 
...
all.mpa.types <- as.factor(unique(as.character(or_mpas$Label)))
