...
How many days has the ship been on the water versus how many days were planned? This is derived from the entire vessel track, regardless of whether we were conducting a survey, including transits, etc. [**Red**]{style="color:red"} cells indicate differences between actual and planned dates or values.
...
According to our calculations, a total of **`r sum(das.summary.sub$das.actual, na.rm = T)`** DAS were accomplished of the `r sum(das.summary.sub$das.planned, na.rm = T)` DAS planned, resulting in **`r sum(das.summary.sub$delta.das, na.rm = T)`** fewer DAS than planned.
...
According to our calculations, a total of **`r sum(das.summary.sub$das.survey, na.rm = T)`** DAS were accomplished of the `r sum(das.summary.sub$das.planned, na.rm = T)` DAS planned, resulting in **`r sum(das.summary.sub$delta.survey, na.rm = T)`** fewer days of survey than planned.
