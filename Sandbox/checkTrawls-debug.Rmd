...
pacman::p_load(tidyverse,lubridate,mapview,kableExtra,plotly,leaflet,
...
```{r, eval=FALSE}
ggpenguins <- ggplot(data = palmerpenguins::penguins) + 
...
```{r round-herring-data,eval=FALSE}
# Select species
...
```{r length-weight-leg,eval=FALSE}
lw.df.sub <- lw.df %>% 
  pivot_longer(totalLength_mm:standardLength_mm, names_to = "length_type", values_to = "length_mm")
