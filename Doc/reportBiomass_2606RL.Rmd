...
<!-- In `r tolower(survey.season)` `r survey.year`, transects were sampled south-to-north to coordinate sampling with the hake survey conducted by the Department of Fisheries and Oceans Canada (DFO) aboard Canadian Coast Guard Ship (CCGS) _Sir John Franklin_.   -->
