...
Avenida México 190 Del Carmen  
Coyoacán 04100 Ciudad de México

**Corresponding authors:**  

* NOAA Southwest Fisheries Science Center
  + Dr. David Demer (email: <david.demer@noaa.gov>)
* INAPESCA
  + Dr. Isaac Gonzalez (email: <ramon.rojas@inapesca.gob.mx>)
  
\newpage

# Executive Summary

The `r survey.name.long` was conducted by NOAA's Southwest Fisheries Science Center (SWFSC), in collaboration with scientists from Instituto Nacional de Pesca (INAPESCA), aboard NOAA Ship *`r survey.vessel.long`* (hereafter, *`r survey.vessel`*), `r survey.start` to `r survey.end` `r survey.year`. The Acoustic-Trawl Method (ATM) is routinely used to assess coastal pelagic fish species (CPS) and krill within the California Current Ecosystem (CCE), between Vancouver Island, British Columbia and San Diego, CA. In 2021, for the first time, the survey extended southward to central Baja California, Mexico. Data were collected using multi-frequency echosounders, surface trawls, obliquely integrating net tows, a continuous underway fish-egg sampler (CUFES), and conductivity-temperature-depth probes (CTDs).
...
_`r survey.vessel`_ entered Mexican waters on 7 October and sampling occurred from north to south. The survey spanned the area from approximately the U.S.-Mexico border in the north to Bahia Santa Maria near San Quintin, Baja California in the south. _`r survey.vessel`_ sampled `r nrow(nasc.summ)` east-west transects totaling `r prettyNum(sum(nasc.summ$distance), digits = 1, big.mark = ",")` nmi, and conducted `r nrow(trawl.summ)` Nordic trawls. A total of `r nrow(uctd.sta)` UCTD casts were conducted, and `r prettyNum(nrow(cufes), digits = 1, big.mark = ",")` CUFES samples were collected underway. 

Acoustic backscatter sampled by  _`r survey.vessel`_ and ascribed to CPS was observed throughout the survey area, but was most prevalent within ~10 nmi of shore. Fish eggs observed in the CUFES were mostly identified as Pacific Sardine eggs; however, these identifications must be verified. A few Jack Mackerel and Northern Anchovy eggs were also observed. Northern Anchovy catches were predominant, by weight, in trawl samples collected throughout the survey area in Mexico. Jack Mackerel were most abundant in several trawls offshore and Pacific Sardine were most abundant in several trawls close to shore. A few Pacific Mackerel were collected. Overall, the `r nrow(trawl.summ)` trawls captured a combined `r prettyNum(haul.CPS.kg, digits = 1, big.mark = ",")` kg of CPS (`r prettyNum(haul.Sardine.kg, digits = 1, big.mark = ",")` kg Pacific Sardine, `r prettyNum(haul.Anchovy.kg, digits = 1, big.mark = ",")` kg Northern Anchovy, `r prettyNum(haul.JackMack.kg, digits = 1, big.mark = ",")` kg Jack Mackerel, and `r prettyNum(haul.PacMack.kg, digits = 1, big.mark = ",")` kg Pacific Mackerel). On 15 October, _`r survey.vessel`_ arrived at the 10th Avenue Marine Terminal in San Diego to complete the survey.  

Analysis of the data collected is ongoing. Estimates of abundance and biomass will be presented in future reports.
...
A total of `r nrow(uctd.sta)` UCTD casts were conducted, and `r prettyNum(nrow(cufes), digits = 1, big.mark = ",")` CUFES samples were collected underway. The locations of CTD and UCTD stations are presented in **Fig. \@ref(fig:station-sampling)** and **Appendix \@ref(appendix-ctd-sampling)**.  
...
All raw EK80, ME70, MS70, and SX90 data are archived on the SWFSC data server. For more information, contact: Kevin Stierhoff (Southwest Fisheries Science Center, 8901 La Jolla Shores Drive, La Jolla, California, 92037, U.S.A.; phone: 831-420-3919; email: <kevin.stierhoff@noaa.gov>).

# Acknowledgements {#acknowledgements}  

We thank the crew members of NOAA Ship _`r survey.vessel`_, as well as the scientists that participated in the sampling operations at sea. We especially thank our collaborators from Mexico who participated in Legs II-IV. We also thank Wendy Bradfield-Smith, Graciela Alvarez, Ed Gorecki, Dr. Cisco Werner, Dr. Pablo Arenas, Adm. Chad Cary, and many others who assisted in the preparation and approval of the Mexican research permit. Finally, we thank Dale Sweetnam, Roszella Sanford, and Freddie Logan, who coordinated funding, travel, and lodging for our many colleagues who participated in the survey.  

**Isaac, Roberto, please identify any people in your organization who should be acknowledged.**
