...
Actual survey progress by _`r survey.vessel`_ (pink line) relative to the original plan (gray line). Filled points indicate dates when acoustic/trawl sampling occurred (i.e., survey days), while open points indicate transits. The vertical and horizontal dashed lines represent the expected date and latitude at the end of each planned survey leg, respectively.  
