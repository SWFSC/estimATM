...
# Define leg ends
leg.ends <- c(ymd("2020-03-25"), ymd("2020-04-18"))
...
survey.start.sd  <- "2020-06-13" # Start of Saildrone survey
survey.end.sd    <- "2020-09-09" # End of Saildrone survey
...
cruise.name <- 202007 # May be a numeric or numeric vector (e.g., c(201704,201706,...))
