...
```{r uctd-dZt-plot,out.width="100%",out.height="8in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
...
```{r uctd-depth-time-plot,out.width="100%",out.height="8in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
      # plot depth v time
...
```{r uctd-temp-depth-plot,out.width="100%",out.height="8in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
...
```{r uctd-sal-depth-plot,out.width="100%",out.height="8in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
...
```{r uctd-sv-depth-plot,out.width="100%",out.height="8in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
    if (save.figs) {
...
```{r uctd-chl-depth-plot,out.width="100%",out.height="8in"}
if (exists("all.uctd.casts")) {
  if (length(all.uctd.casts) > 0) {
...
```{r ctd-temp-depth-plot,out.width="100%",out.height="8in"}
if (exists("all.ctd.casts")) {
  if (length(all.ctd.casts) > 0) {
    if (save.figs) {
      # plot temperature v depth
...
```{r ctd-sv-depth-plot,out.width="100%",out.height="8in"}
if (exists("all.ctd.casts")) {
  if (length(all.ctd.casts) > 0) {
    if (save.figs) {
      # plot sound speed v depth
