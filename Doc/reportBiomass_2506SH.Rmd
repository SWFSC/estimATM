...
(ref:sardine-stock-allocation) Summary of lengths for Pacific Sardine sampled during the summer **2025** survey:  a) relative length distribution of individuals classified as northern (blue) and southern (red) subpopulations (NSP and SSP, respectively); b) individual length measurements (grey points) and mean lengths (blue and red points for NSP and SSP, respectively) for each trawl cluster versus latitude; and c) locations of trawls clusters with Pacific Sardine assigned to each subpopulation (blue and red points) based on the predicted potential habitat for the NSP [@Zwolinski2024] at the midpoint of the survey **(August XX, 2025)**. **[Juan, provide an updated version of this figure]**

```{r sardine-stock-allocation,fig.cap='(ref:sardine-stock-allocation)',out.width='5in',fig.pos='H'}
