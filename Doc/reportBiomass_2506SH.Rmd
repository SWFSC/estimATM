...
The core survey region, which was sampled by NOAA ship _`r survey.vessel.long`_ (hereafter, _`r survey.vessel`_), spanned most of the continental shelf between `r survey.landmark.s`, CA and `r survey.landmark.n`. Planned transects were oriented approximately perpendicular to the coast in the SCB, and east-to-west north of Pt. Conception, from the shallowest navigable depth (~`r safe.depth.fsv` m) to a distance of 35 nmi offshore or, if farther, to the 1,000 ftm (~1830 m) isobath. In the SCB, transects in the core region were extended to approximately 100 nmi.      
