...
## Import set data 
### LM
lm.sets <- readxl::read_excel(file.path(survey.dir["LM"], "DATA/SEINE/lm_data_2307RL.xlsx"), 
                      sheet = "sets") %>%
...
## LBC
lbc.sets <- googlesheets4::read_sheet("1LdEnwL62ySTDjSd9hLZscqSyGlucUniydj60yctCuZc", sheet = "sets") %>%
