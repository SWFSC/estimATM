...
pie.spp.lm  <- c("Clupea pallasii","Sardinops sagax","Scomber japonicus","Trachurus symmetricus")
pie.spp.lbc <- c("Clupea pallasii","Sardinops sagax","Scomber japonicus","Trachurus symmetricus")
