# Install the xml2 package if you haven't already
...
# 1. Read the XML file 
# (Make sure the file path matches where the file is stored on your computer)
...
# 5. Function to parse "YYYYMMDDThhmmss XX.XXXXX N YY.YYYYY W"
