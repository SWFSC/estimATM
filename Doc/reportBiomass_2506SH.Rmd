...
**For additional information about the 2025 Summer IWCPS, see the detailed survey report by de Blois et al. (In prep.).**  
...
$TS$ has units of dB re 1 m^2^ if defined for an individual, or dB re 1 m^2^ kg^-1^ if defined by weight. The following equations for $TS_{38\mathrm{kHz}}$ were used in this analysis **[double-check these equations]**:  
...
#### Combined northern and southern subpopulation
...
Unbiased classification of CPS in the epipelagic region still requires random or representative sampling of all schools observed along the transects. In the presence of a strong inshore-offshore gradient of the species distribution (**Figs. \@ref(fig:species-proportion-inshore-offshore-2025)**), the preferential sampling in the nearshore region (Figure x) introduces an unquantified bias. Specifically, the preferential sampling of the Pacific Sardine-dominated region very close to the shore (i.e., less than 1 nmi in most cases; **Figs. \@ref(fig:species-proportion-inshore-offshore-2025)**), is poor at characterizing the transition to areas inhabited by Northern Anchovy. Using our standard approach, dense, unsampled CPS schools observed up to 5 nmi from the central coast of California were classified as Pacific Sardine based on purse-seine sets conducted very close to shore (**Figs. \@ref(fig:nearshore-sampling-bias-2025)** and **\@ref(fig:species-proportion-inshore-offshore-2025)**). As a result, estimates of Pacific Sardine biomass may be positively biased by the inclusion of Northern Anchovy backscatter. In 2026, we plan to shift the timing of purse-seine sampling for the nearshore survey towards the evening, which is expected to allow for more representative biological sampling of CPS community.  
